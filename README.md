...
<img src="docs/images/day-light.png" width="436" alt="CalPeek's popover showing the next meeting with a Join button, a month grid with event dots, and a day agenda listing events and reminders">
</picture>
...
<picture>
<source media="(prefers-color-scheme: dark)" srcset="docs/images/day-dark.png">
<img src="docs/images/day-light.png" width="436" align="right" alt="CalPeek&apos;s popover with the month grid open and a day panel listing Team standup, Lunch with Sam, Design review, a Submit timesheet reminder and Portfolio review with their times">
</picture>
...
<img src="docs/images/join-light.png" width="369" align="right" alt="CalPeek&apos;s popover with the next meeting pinned at the top, showing a countdown and a Join button">
</picture>
...
<img src="docs/images/chooser-light.png" width="369" align="right" alt="CalPeek&apos;s popover with a meeting running and the Join button carrying a chevron for choosing between overlapping calls">
</picture>
...
<img src="docs/images/create-light.png" width="436" align="right" alt="CalPeek&apos;s create sheet with Event and Reminder tabs, a title reading Coffee with Dana, start and end times, repeat, and alert fields">
</picture>
...
<img src="docs/images/appearance-light.png" width="452" alt="CalPeek&apos;s Appearance settings with color pickers for the weekday name, today&apos;s marker, calendar event dots, and reminder dots">
</picture>
</p>
...
<img src="docs/images/settings-light.png" width="392" align="right" alt="CalPeek&apos;s General settings showing Launch at Login, Calendar and Reminders permissions, and Next Meeting options including a join shortcut">
</picture>
